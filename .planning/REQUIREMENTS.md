...
- [x] **XLSEXPORT-01**: Usuario puede exportar cada uno de los 6 reportes contables existentes (Libro Mayor, Libro auxiliar, movimientos por tercero, balance de comprobación, cartera de clientes, cuentas por pagar) en `.xlsx`, además del CSV ya existente
