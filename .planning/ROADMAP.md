...
- [ ] **Phase 1: Cotización electrónica (Fase A)** - Cotizar, transicionar estados y convertir a ingreso sin duplicados
...
|-------|----------------|--------|-----------|
| 1. Cotización electrónica (Fase A) | 3/4 | In Progress|  |
